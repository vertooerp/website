...
| | Excel | ERP |
|---|---|---|
| Datenbasis | Verteilt, mehrfach | Zentral, einmalig |
| Mehrbenutzer | Konfliktanfällig | Gleichzeitig, rollenbasiert |
| Nachvollziehbarkeit | Kaum | Audit-Trail |
| Automatisierung | Manuell/Makros | Eingebaute Workflows |
| Skalierung | Bricht ab Größe X | Wächst mit |
